    ...
    <div className=" bg-blue-200 ">
      <div className="navbar max-w-full px-5 border ">
        <div className="navbar-start">
          <Link to={'/'} className=" text-2xl">Super Box</Link>
        </div>
        <div className="navbar-end">
            {
              user?.email ?
              <div className=" flex flex-row justify-center items-center gap-5">
                <Link to={'/my-website'} className="text-xl font-serif text-blue-600 font-semibold hover:underline">My Website</Link>
                  <div className="dropdown dropdown-bottom dropdown-end">
                      ...
                      <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-fit">
                          ...
                          <li><Link to={'/dashboard/welcome-page'} className="">Dashboard</Link></li>
