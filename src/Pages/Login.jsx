        ...
        <div className="min-h-screen  w-full flex flex-row">
            ...
            <div className="py-5 px-20 flex-auto w-1/2 bg-blue-100  ">
                ...
                <form onSubmit={handleLoginWithEmailAndPassword}
                    ...
                    <button type="submit" className="btn btn-info text-white text-xl">Login</button>
                </form>
                <div>
                    <p className=" text-sm font-semibold">Or login with</p>
                    <div className="flex flex-row gap-2 py-2 ">
                        <img onClick={handleGoogleLogin}  className=" w-8" src="https://i.ibb.co/74JTkrp/google-13170545.png" alt="" />
