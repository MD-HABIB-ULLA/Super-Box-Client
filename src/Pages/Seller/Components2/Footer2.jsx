...
const Footer2 = () => {
    return (
        <div className=" bg-blue-200">
            <footer className="footer container mx-auto items-center p-4  ">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2023 Super Box, All rights reserved</p>
                </aside>
                <nav className="flex flex-col ">
                    <h1 className="text-lg font-semibold">Contact us:</h1>

                    <Link className="link link-hover">Email</Link>
                ...
                <nav>
                    ...
                    <div className=" flex flex-row items-start justify-center gap-2 mt-2">
                        <Link><img className=" w-8" src={facebookIcon} alt="" /></Link>
                        <Link><img className=" w-8" src={instagramIcon} alt="" /></Link>
                        <Link><img className=" w-8" src={linkedinIcon} alt="" /></Link>
                        <Link><img className=" w-8" src={twitterIcon} alt="" /></Link>
                        <Link><img className=" w-8" src={youTubeIcon} alt="" /></Link>
