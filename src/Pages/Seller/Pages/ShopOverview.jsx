...
const ShopOverview = () => {
    return (
        <div className="my-10 border bg-blue-200">
                ...
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:dark:bg-gray-900 dark:dark:text-gray-100">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-4xl font-semibold leadi">200<span className="text-4xl">+</span></p>
                    ...
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:dark:bg-gray-900 dark:dark:text-gray-100">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-semibold leadi">7500<span className="text-4xl">+</span></p>
