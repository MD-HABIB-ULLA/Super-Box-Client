...
const CreateShop = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (user) {
            ...
            //img upload to imgbb and get an url
            const res2 = await axiosPublic.post(image_hosting_api, imageFiles2, {
                headers: {
                    "Content-Type": 'multipart/form-data'
                }
            });
            ...
            <form onSubmit={handleSubmit(onSubmit)} className=" p-5 rounded-lg ">
                ...
                <div className="grid grid-cols-3 gap-4 border-b-2 border-dashed pb-10 mb-10">
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <input type="text" placeholder="Enter a Brand Name"
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <input {...register('brandLogo', { required: true })} type="file" className="file-input  input-bordered" />
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <input {...register('brandBanner', { required: true })} type="file" className="file-input  input-bordered" />
                ...
                <div className="grid grid-cols-3 gap-4 border-b-2 border-dashed pb-10 mb-10">
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <select defaultValue="default" {...register("navColor", { required: true })} className="select select-bordered  ">
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <select defaultValue="default" {...register("navLayout", { required: true })} className="select select-bordered  ">
                            <option disabled value="default">Select a Layout</option>
                            <option value="default">Select a guide</option>
                            <option value="default">Select a guide</option>
                            {/* {
                            guideList?.map((item, index) => <option key={index} value={item.name}>{item.name}</option>)
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <select defaultValue="default" {...register("navFontColor", { required: true })} className="select select-bordered ">
                            <option disabled value="default">Select Font Color</option>
                            <option value="default">Select a guide</option>
                            <option value="default">Select a guide</option>
                            {/* {
                            guideList?.map((item, index) => <option key={index} value={item.name}>{item.name}</option>)
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <select defaultValue="default" {...register("navFontSize", { required: true })} className="select select-bordered ">
                            <option disabled value="default">Select Font Size</option>
                            <option value="default">Select a guide</option>
                            <option value="default">Select a guide</option>
                            {/* {
                            guideList?.map((item, index) => <option key={index} value={item.name}>{item.name}</option>)
                ...
                <div className="grid grid-cols-3 gap-4 border-b-2 border-dashed pb-10 mb-10">
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <select defaultValue="default" {...register("bgColor", { required: true })} className="select select-bordered  ">
                            <option disabled value="default">Select a color</option>
                            <option value="default">Select a guide</option>
                            <option value="default">Select a guide</option>
                            {/* {
                            guideList?.map((item, index) => <option key={index} value={item.name}>{item.name}</option>)
                    ...
                    <div className="form-control w-full my-6">
                        ...
                        <select defaultValue="default" {...register("secTitleColor", { required: true })} className="select select-bordered  ">
                            <option disabled value="default">Select a color</option>
                            <option value="default">Select a guide</option>
                            <option value="default">Select a guide</option>
                            {/* {
                    ...
                    <div className="form-control w-full my-6">
                        <label className="label">
                            <span className="label-text text-xl">Sections Title Font Size</span>

                        </label>
                        <select defaultValue="default" {...register("secTitleFontSize", { required: true })} className="select select-bordered  ">
                            <option disabled value="default">Select a Font Size</option>
                            <option value="default">Select a guide</option>
                            <option value="default">Select a guide</option>
                            {/* {
                            guideList?.map((item, index) => <option key={index} value={item.name}>{item.name}</option>)
